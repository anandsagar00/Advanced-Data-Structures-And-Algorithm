...
int main()
{
    ...
    /*
    since the array given to us is sorted , so the point/index where 2 letters don't match in the 2 strings
    is the point where the letter in previous string is smaller than the next one
    */
